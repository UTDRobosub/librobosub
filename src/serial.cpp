...
namespace robosub {
    ...
    void serialOnReceiveMessage(void *instance, char *message, int length, bool needsresponse, char **response,
                                int *responselength) {
        Serial *ser = (Serial *) instance;
    ...
    Serial::Serial(string fn, int baud,
                   void (*_receiveMessageCallback)(char *message, int length, bool needsrepsonse, char **response,
                                                   int *responsepength), bool useprotocol, bool debugprint) {
        connected = false;
        ...
        switch (baud) {
            ...
            case 4000000:
                ...
                break;
            default:
                cout << "Serial port \'" << filename << "\' invalid baud rate specified" << endl;
        }
        ...
        state = Serial_NewState(this, useprotocol, serialOnReceiveMessage, serialSendChar, serialDelayMs,
                                serialPollReceive);
