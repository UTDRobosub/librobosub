...
namespace robosub {
    ...
    void Drawing::rectangle(Mat &img, Point one, Point two, Scalar borderColor, Scalar fillColor, int thickness,
                            int lineType) {
    ...
    void
    Drawing::rectangle(Mat &img, Rect rectangle, Scalar borderColor, Scalar fillColor, int thickness, int lineType) {
        vector <Point> points;
    ...
    void Drawing::contours(Mat &img, vector <Contour> &contours, Scalar borderColor, Scalar fillColor, int thickness,
                           int lineType) {
