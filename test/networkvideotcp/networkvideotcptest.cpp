...
//	cout << cv::getBuildInformation() << endl;
    ...
    return displayFrames(mode, port, addr, showDisplay, camera, frameSize);
}

int displayFrames(int mode, int port, const String &addr, bool showDisplay, const string &camera,
                  Size &frameSize) {//catch signal
            ...
            *(int *) (senddata + 12) = 0;
            ...
            if (showDisplay) {
                Drawing::text(frame1,
                              ...
                              Point(16, 48), Scalar(255, 255, 255), Drawing::BOTTOM_LEFT, 0.5
                );
                Drawing::text(frame1,
                              String(Util::toStringWithPrecision(uploadBitsPerSecond / 1024.0 / 1024.0)) +
                              String(" Mbps"),
                              Point(16, 16), Scalar(255, 255, 255), Drawing::BOTTOM_LEFT, 0.5
                );
