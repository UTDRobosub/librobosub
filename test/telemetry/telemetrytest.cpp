...
int main(int argc, char **argv) {
    ...
    root.on_message = [&connectionState](shared_ptr <WsServer::Connection> connection,
    ...
    //GET "/": on close
    root.on_close = [&connectionState](shared_ptr <WsServer::Connection> connection, int status,
                                       const string & /*reason*/) {
    ...
    //GET "/": on error
    root.on_error = [&connectionState](shared_ptr <WsServer::Connection> connection,
